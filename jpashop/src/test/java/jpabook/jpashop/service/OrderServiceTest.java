...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception{
        ...
        Assert.assertEquals("주문 취소 시 상태는 CANCEL이 되어야한다.", OrderStatus.CANCEL, getOrder.getStatus());
        Assert.assertEquals("주문을 취소했으므로 재고 수량이 유지되어야 한다.", 10, book.getStockQuantity());
    }
